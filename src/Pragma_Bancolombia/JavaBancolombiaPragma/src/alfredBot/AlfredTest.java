...
public class AlfredTest {
    ...
    public static void main(String[] args) {
        ...
        String testGuestGreeting2 = alfredBot.guestGreeting("David", "SuperMan"); //Created
        String testDateAnnouncement = alfredBot.dateAnnouncement();
        String botAlfredQuote = alfredBot.botAlfredQuote("Wonder Woman"); //Created
        ...
        // System.out.println(botAlfredQuote);
    }
}
