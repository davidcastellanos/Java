...
public class TestPedidos {
    public static void main(String[] args) {
        ...
        System.out.println("pedido2.getTotal() = " + pedido2.getOrderTotal());

        //pedido3 pidió un capuchino. Agrega el capuchino a su lista de pedido y a su cuenta.
        pedido3.items.add(articulo4);
        System.out.println("pedido3.getTotal() = " + pedido3.getOrderTotal());
        ...
        System.out.println("pedido4.getTotal() = " + pedido4.getOrderTotal());
